...
from .views import user_filter_page, property_filter_view,user_login,user_register,log_whatsapp_and_redirect, detail_view,log_call_and_redirect,mobile_login
